#!/usr/bin/env python3
"""
Recuperation des codes promo Farfetch depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/farfetch.com
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/farfetch.com"
STORE_NAME = "Farfetch"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Farfetch depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-farfetch)"
    }
    try:
