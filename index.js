 ...
 * Homepage: https://shopilo.fr/reductions/farfetch.com
 */

const SHOPILO_URL = "https://shopilo.fr/reductions/farfetch.com";
const STORE_NAME  = "Farfetch";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-fr/code-promo-farfetch)" }
  });
